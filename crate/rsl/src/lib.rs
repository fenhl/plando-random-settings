...
impl fmt::Display for Preset {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            Preset::Beginner => write!(f, "beginner — Random Settings for Beginners"),
            Preset::Intermediate => write!(f, "intermediate — a step between Beginner and League"),
    ...
    fn from(options: GenOptions) -> Weights {
        match options {
            ...
            GenOptions::Preset(preset) => {
                ...
                match preset {
                    Preset::Beginner => weights += serde_json::from_str(include_str!("../../../assets/weights/override-beginner.json")).expect("failed to load Beginner overrides"),
                    Preset::Intermediate => weights += serde_json::from_str(include_str!("../../../assets/weights/override-intermediate.json")).expect("failed to load Intermediate overrides"),
