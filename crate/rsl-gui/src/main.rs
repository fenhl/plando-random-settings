        ...
        Column::new()
            ...
            .push(Container::new(match self.tab {
                ...
                Tab::Solo => Scrollable::new(&mut self.scroll)
                    .push(Row::new()
                        .push(Radio::new(Preset::Beginner, "Beginner", Some(self.solo_preset), Message::SetSoloPreset))
                        .push(Radio::new(Preset::Intermediate, "Intermediate", Some(self.solo_preset), Message::SetSoloPreset))
                        .spacing(16)
                    )
                    .push(Row::new()
                    ...
                    .push(Text::new(match self.solo_preset {
                        Preset::Beginner => "Weights for players who have Standard experience but are new to random settings. No Master Quest, maximum of one ER pool, no quad damage, some other simplifications.",
                        Preset::Intermediate => "Something in between Beginner and League. Maximum of 1 MQ dungeon, no overworld ER, no OHKO or Hero Mode, some other simplifications.",
